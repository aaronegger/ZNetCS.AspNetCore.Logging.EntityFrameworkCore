    ...
    where TContext : DbContext
{
    ...
    /// </param>
    public EntityFrameworkLoggerProvider(IServiceProvider serviceProvider, Func<string, LogLevel, bool> filter, Func<int, int, string, string, string?, string?, Exception?, Log>? creator = null)
    ...
    where TContext : DbContext
{
    ...
    /// The creator used to create new instance of log.
    /// </param>
    public EntityFrameworkLoggerProvider(IServiceProvider serviceProvider, Func<string, LogLevel, bool> filter, Func<int, int, string, string, string?, string?, Exception?, TLog>? creator = null)
        : base(serviceProvider, filter, creator)
    {
    }
    ...
    where TKey : IEquatable<TKey>
{
    ...
    /// </summary>
    private readonly Func<int, int, string, string, string?, string?, Exception?, TLog>? creator;
    ...
    public EntityFrameworkLoggerProvider(IServiceProvider serviceProvider, Func<string, LogLevel, bool> filter, Func<int, int, string, string, string?, string?, Exception?, TLog>? creator = null)
    {
        ...
        this.factory = ActivatorUtilities.CreateFactory(
            typeof(TLogger),
            new[] { typeof(string), typeof(Func<string, LogLevel, bool>), typeof(Func<int, int, string, string, string?, string?, Exception?, TLog>) });
    }
