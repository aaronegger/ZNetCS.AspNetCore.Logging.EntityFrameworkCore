    ...
    where TContext : DbContext
{
    ...
    /// </param>
    public EntityFrameworkLoggerProvider(IServiceProvider serviceProvider, Func<string, LogLevel, bool> filter, Func<int, int, string, string, string?, string?, Exception?, IServiceProvider, Log>? creator = null)
    ...
    where TContext : DbContext
{
    ...
    /// The creator used to create new instance of log.
    /// </param>
    public EntityFrameworkLoggerProvider(IServiceProvider serviceProvider, Func<string, LogLevel, bool> filter, Func<int, int, string, string, string?, string?, Exception?, IServiceProvider, TLog>? creator = null)
        : base(serviceProvider, filter, creator)
    {
    }
    ...
    where TKey : IEquatable<TKey>
{
    ...
    /// </summary>
    private readonly Func<int, int, string, string, string?, string?, Exception?, IServiceProvider, TLog>? creator;
    ...
    public EntityFrameworkLoggerProvider(IServiceProvider serviceProvider, Func<string, LogLevel, bool> filter, Func<int, int, string, string, string?, string?, Exception?, IServiceProvider, TLog>? creator = null)
    {
        ...
        this.factory = ActivatorUtilities.CreateFactory(
            typeof(TLogger),
            new[] { typeof(string), typeof(Func<string, LogLevel, bool>), typeof(Func<int, int, string, string, string?, string?, Exception?, IServiceProvider, TLog>) });
    }
